...
I build highly scalable, secure-by-design systems and intelligent orchestration frameworks. With over a decade of production experience, I bridge the gap between enterprise backend architectures, complex micro-frontends, cloud infrastructure, and emerging AI technologies.

---

### 🚀 System Architecture & Focus

*   **🌐 Portfolio:** Explore my work, deep dives, and projects at **[alrazi.netlify.app](https://alrazi.netlify.app)**
*   **🛡️ Cybersecurity Focus:** Deep-diving into application security (AppSec), penetration testing, secure coding practices, and system hardening.
*   **🤖 AI & Next-Gen:** Optimizing Cursor workflows, integrating LLMs, exploring Computer Vision, and rendering immersive 3D web environments.
*   **🏗️ Full-Stack Systems:** Engineering high-throughput distributed architectures, microservices, and robust cloud-native applications.
*   **📐 Frontend Architecture:** Designing enterprise-grade micro-frontends and reactive state ecosystems using modern Signals and monorepo patterns.
*   **📫 Secure Signal:** Reach out via **[a.razinejad@gmail.com](mailto:a.razinejad@gmail.com)** or find me on **[LinkedIn](https://linkedin.com/in/alirazinejad)**.
...
#### 🧠 AI, GenAI & 3D Graphics
<p align="left">
  <img src="https://img.shields.io/badge/LLM_Integration-🧠-purple?style=for-the-badge" alt="LLM Integration" />
  <img src="https://img.shields.io/badge/Computer_Vision-👁️-cyan?style=for-the-badge" alt="Computer Vision" />
  <img src="https://img.shields.io/badge/Cursor_AI_Workflow-⚡-orange?style=for-the-badge" alt="Cursor Optimized" />
  ...
  <img src="https://img.shields.io/badge/Babylon.js-🎮-b8479a?style=for-the-badge" alt="Babylon.js" />
</p>
